...
class PlayerDamageText private constructor(
    private val gameContext: GameContext,
) : IGameObject, IRecyclable {

    companion object {
        private const val TEXT_WIDTH = 100f
        private const val TEXT_HEIGHT = 35f
        ...
        fun get(
            ...
            val text = world.obtain(PlayerDamageText::class.java)
                ?: PlayerDamageText(gctx)
    ...
    private fun init(
        ...
        paint.color = Color.rgb(0xFF, 0x00, 0x00)
